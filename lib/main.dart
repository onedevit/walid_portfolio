...
class _PortfolioHomeState extends State<PortfolioHome> {
  ...
  final Map<String, Map<String, String>> _translations = {
    ...
    'en': {
      ...
      'skill3Title': 'WordPress & WooCommerce',
      'skill3Desc': 'E-commerce development, custom WordPress/WooCommerce plugin creation, payment gateway integration, and data synchronization.',
      'skill4Title': 'Design & Development',
      'skill4Desc': 'Advanced algorithmic logic (WinDev, WebDev), AI-assisted software development (Flutter Desktop/Mobile, Dart, PHP, JavaScript).',
      ...
      'skill6Desc': 'Full lifecycle (needs analysis, specifications, rapid prototyping, deployment, user training).',
      ...
      'exp1Bullet1': 'End-to-end management of management software projects and e-commerce platforms for over 15 SME clients.',
      'exp1Bullet2': 'Advanced customization of Dolibarr ERP and custom WordPress/WooCommerce plugin development.',
      ...
      'proj1Desc': 'Development and full integration of the Lumina e-commerce platform (www.lumina.com.tn). Custom WordPress & WooCommerce plugin development for advanced order management, product catalog, and data sync.',
      'proj1Tech': 'WordPress, WooCommerce, Custom Plugins, PHP, MySQL, REST API',

      'proj2Title': 'Tax Declaration & Invoice Processing Desktop Software',
      'proj2Desc': 'Desktop app with local OCR (Tesseract) for automatic accounting data extraction and tax report generation without cloud dependencies.',
      'proj2Tech': 'Flutter Desktop, Tesseract OCR, Python Backend',

      'proj3Title': 'Custom Business ERP (Dolibarr)',
      'proj3Desc': 'Deployment of a customized version for law firms and service companies, automating legal documents and financial tracking.',
      'proj3Tech': 'Dolibarr PHP/SQL, Extrafields, REST API',

      'proj4Title': 'ONEDEV Invoice Lite',
      'proj4Desc': 'Commercial management tool with intelligent suggestion and automated entry modules, achieving 60% time savings.',
    ...
    'ar': {
      ...
      'skill3Title': 'ووردبريس وووكمرس (WordPress & WooCommerce)',
      'skill3Desc': 'تطوير المتاجر الإلكترونية، برمجيات وإضافات ووردبريس وووكمرس المخصصة (Custom Plugins)، ربط بوابات الدفع الإلكتروني وتزامن البيانات.',
      'skill4Title': 'التصميم والتطوير',
      'skill4Desc': 'المنطق الخوارزمي المتقدم (WinDev, WebDev)، تطوير التطبيقات المدعوم بالذكاء الاصطناعي (Flutter Desktop/Mobile, Dart, PHP, JavaScript).',
      'skill5Title': 'البنية التحتية والأنظمة',
      'skill5Desc': 'إدارة خوادم Linux (Debian, Ubuntu)، Windows Server، استراتيجيات النسخ الاحتياطي التلقائي (rclone, Google Drive)، NAS والشبكات المحلية.',
      ...
      'exp1Role': 'مؤسس ومدير مشاريع تقني / مكامل أنظمة ERP والويب',
      'exp1Company': 'ONEDEV – قصر هلال، تونس | يناير 2016 – الحالي',
      'exp1Bullet1': 'قيادة كاملة لمشاريع البرمجيات الإدارية ومنصات التجارة الإلكترونية لمجموعة تضم أكثر من 15 شركة PME.',
      'exp1Bullet2': 'التصميم والتخصيص المتقدم لنظام ERP Dolibarr وتطوير إضافات ووردبريس وووكمرس مخصصة (Custom Plugins).',
      ...
      'proj1Desc': 'تطوير وتكامل كامل لمنصة التجارة الإلكترونية Lumina (www.lumina.com.tn). برمجة إضافات مخصصة لووردبريس وووكمرس لإدارة الطلبات والمنتجات وتزامن البيانات.',
      'proj1Tech': 'WordPress, WooCommerce, Plugins Sur-Mesure, PHP, MySQL, REST API',

      'proj2Title': 'برنامج التصريح الجبائي ومعالجة الفواتير (Desktop)',
      'proj2Desc': 'تطبيق يدمج محرك OCR محلي (Tesseract) للاستخراج الآلي للبيانات المحاسبية وإعداد القوائم المالية بدون اعتماد سحابي.',
      'proj2Tech': 'Flutter Desktop, Tesseract OCR, Python Backend',

      'proj3Title': 'نظام ERP Dolibarr مخصص للمهن',
      'proj3Desc': 'نشر نسخة مخصصة لمكاتب المحاماة والشركات الخدمية، تمتتة إنشاء الوثائق القانونية والمتابعة المالية.',
      'proj3Tech': 'Dolibarr PHP/SQL, Extrafields, REST API',

      'proj4Title': 'ONEDEV Facture Lite',
      'proj4Desc': 'أداة إدارة تجارية مع وحدات اقتراح وإدخال آلي ذكية، توفر 60% من وقت المستخدمين.',
      'proj4Tech': 'Flutter Mobile/Desktop, Modules IA, SQLite',
